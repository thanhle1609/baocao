...
public class DH004 {
	private WebDriver driver;
	  ...
	  @Test
	  public void testDH003() throws Exception {
	    driver.get(baseUrl + "/");
	    ...
	    driver.findElement(By.linkText("ốp lưng hình thú iphone 5")).click();
	    for (int second = 0;; second++) {
	    	if (second >= 60) fail("timeout");
	    ...
	    try {
	      assertEquals(driver.findElement(By.id("address-region-district-error")).getText(), "Vui lòng nhập quận/huyện.");
	    } catch (Error e) {
