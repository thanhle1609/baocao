...
public class DH001 {
	 private WebDriver driver;
	  ...
	  @Test
	  public void testDH001() throws Exception {
	    driver.get(baseUrl + "/");
	    ...
	    for (int second = 0;; second++) {
	    	...
	    	try { if ("Ốp Lưng Điện Thoại Hình Thú".equals(driver.findElement(By.cssSelector("div.cate-big-img > a.cate-view > span")).getText())) break; } catch (Exception e) {}
	    	Thread.sleep(1000);
	    }

	    driver.findElement(By.cssSelector("div.cate-big-img > a.cate-view > span")).click();
	    for (int second = 0;; second++) {
	    	if (second >= 60) fail("timeout");
	    ...
	    try {
	      assertEquals(driver.findElement(By.cssSelector("span.tl")).getText(), "Thông tin người nhận");
	    } catch (Error e) {
