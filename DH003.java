...
public class DH003 {
	private WebDriver driver;
	  ...
	  @Test
	  public void testDH03() throws Exception {
	    driver.get(baseUrl + "/");
	    ...
	    try {
	      assertTrue(driver.findElement(By.cssSelector("div.message_error")).getText().matches("^exact:\\([\\s\\S]*\\) Vui lòng nhập địa chỉ đường!"));
	    } catch (Error e) {
